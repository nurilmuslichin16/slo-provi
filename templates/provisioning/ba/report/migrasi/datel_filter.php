					...
					<div class="col-lg-5" style="border-right: 1px solid #eee;">
						<div class="table-respomigive">
							<table id="table" class="table table-bordered table-sm">
								...
								<tr>
									<td><b>BYL</b></td>
									<td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/fviewnok?datel=BYL&tahun=' . $tahun . '&bulan=' . $month . '&order=mig') ?>"><?= $rmig['bylblmba']; ?></a></td>
								...
								<tr>
									<td><b>KLX</b></td>
									<td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/fviewnok?datel=KLX&tahun=' . $tahun . '&bulan=' . $month . '&order=mig') ?>"><?= $rmig['klxblmba']; ?></a></td>
								...
								<tr>
									<td><b>GLD</b></td>
									<td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/fviewnok?datel=GLD&tahun=' . $tahun . '&bulan=' . $month . '&order=mig') ?>"><?= $rmig['gldblmba']; ?></a></td>
								...
								<tr>
									<td><b>KRT</b></td>
									<td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/fviewnok?datel=KRT&tahun=' . $tahun . '&bulan=' . $month . '&order=mig') ?>"><?= $rmig['krtblmba']; ?></a></td>
								...
								<tr>
									<td><b>KTO</b></td>
									<td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/fviewnok?datel=KTO&tahun=' . $tahun . '&bulan=' . $month . '&order=mig') ?>"><?= $rmig['ktoblmba']; ?></a></td>
								...
								<tr>
									<td><b>MSO</b></td>
									<td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/fviewnok?datel=MSO&tahun=' . $tahun . '&bulan=' . $month . '&order=mig') ?>"><?= $rmig['msoblmba']; ?></a></td>
								...
								<tr>
									<td><b>SLO</b></td>
									<td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/fviewnok?datel=SLO&tahun=' . $tahun . '&bulan=' . $month . '&order=mig') ?>"><?= $rmig['sloblmba']; ?></a></td>
								...
								<tr>
									<td><b>KAR</b></td>
									<td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/fviewnok?datel=KAR&tahun=' . $tahun . '&bulan=' . $month . '&order=mig') ?>"><?= $rmig['karblmba']; ?></a></td>
								...
								<tr>
									<td><b>SRG</b></td>
									<td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/fviewnok?datel=SRG&tahun=' . $tahun . '&bulan=' . $month . '&order=mig') ?>"><?= $rmig['srgblmba']; ?></a></td>
								...
								<tr>
									<td><b>SKH</b></td>
									<td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/fviewnok?datel=SKH&tahun=' . $tahun . '&bulan=' . $month . '&order=mig') ?>"><?= $rmig['skhblmba']; ?></a></td>
								...
								<tr>
									<td><b>WNG</b></td>
									<td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/fviewnok?datel=WNG&tahun=' . $tahun . '&bulan=' . $month . '&order=mig') ?>"><?= $rmig['wngblmba']; ?></a></td>
								...
								<tr>
									...
									<td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/fviewnok?datel=all&tahun=' . $tahun . '&bulan=' . $month . '&order=mig') ?>"><?= $rmig['gtblmba']; ?></a></td>
