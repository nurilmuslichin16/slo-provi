...
<div class="col-xs-12 col-sm-12 widget-container-col" id="widget-container-col-1">
	<div class="widget-box widget-color-dark" id="widget-box-1">
		<div class="widget-header">
			<h5 class="widget-title">BA Material Report (MITRA)</h5>
					...
					<div class="col-lg-5" style="border-right: 1px solid #eee;">
						<div class="table-responsive">
							<table id="table" class="table table-bordered table-sm">
			                  ...
			                  <tr>
			                    <td><b>HCP</b></td>
			                    <td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/viewmnok?mitra=HCP&order=mig') ?>"><?= $rmit['hcpblmba']; ?></a></td>
			                  ...
			                  <tr>
			                    <td><b>KOPEG</b></td>
			                    <td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/viewmnok?mitra=KOPEG&order=mig') ?>"><?= $rmit['kopegblmba']; ?></a></td>
			                  ...
			                  <tr>
			                    <td><b>NUTEL</b></td>
			                    <td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/viewmnok?mitra=NUTEL&order=mig') ?>"><?= $rmit['nutelblmba']; ?></a></td>
			                  ...
			                  <tr>
			                    <td><b>ZAG</b></td>
			                    <td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/viewmnok?mitra=ZAG&order=mig') ?>"><?= $rmit['zagblmba']; ?></a></td>
			                  ...
			                  <tr>
			                    <td><b>SMSI</b></td>
			                    <td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/viewmnok?mitra=SMSI&order=mig') ?>"><?= number_format($rmit['smsiblmba']); ?></a></td>
			                  ...
			                  <tr>
			                    <td><b>TKM</b></td>
			                    <td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/viewmnok?mitra=TKM&order=mig') ?>"><?= $rmit['tkmblmba']; ?></a></td>
			                  ...
			                  <tr>
			                    <td><b>TA</b></td>
			                    <td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/viewmnok?mitra=TA&order=mig') ?>"><?= $rmit['tablmba']; ?></a></td>
			                  ...
			                  <tr>
			                    <td><b>GLOBAL</b></td>
			                    <td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/viewmnok?mitra=GLOBAL&order=mig') ?>"><?= $rmit['globalblmba']; ?></a></td>
			                  ...
			                  <tr>
			                    <td><b>KES</b></td>
			                    <td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/viewmnok?mitra=KES&order=mig') ?>"><?= $rmit['kesblmba']; ?></a></td>
			                  ...
			                  <tr>
			                    ...
			                    <td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/viewmnok?mitra=all&order=mig') ?>"><?= $rmit['gtblmba']; ?></a></td>
