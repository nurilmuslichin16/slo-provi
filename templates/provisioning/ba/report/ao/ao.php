					...
					<div class="col-lg-5" style="border-right: 1px solid #eee;">
						<div class="table-respoaoive">
							<table id="table" class="table table-bordered table-sm">
								...
								<tr>
									<td><b>BYL</b></td>
									<td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/viewnok?datel=BYL&order=ao') ?>"><?= $rao['bylblmba']; ?></a></td>
								...
								<tr>
									<td><b>KLX</b></td>
									<td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/viewnok?datel=KLX&order=ao') ?>"><?= $rao['klxblmba']; ?></a></td>
								...
								<tr>
									<td><b>GLD</b></td>
									<td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/viewnok?datel=GLD&order=ao') ?>"><?= $rao['gldblmba']; ?></a></td>
								...
								<tr>
									<td><b>KRT</b></td>
									<td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/viewnok?datel=KRT&order=ao') ?>"><?= $rao['krtblmba']; ?></a></td>
								...
								<tr>
									<td><b>KTO</b></td>
									<td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/viewnok?datel=KTO&order=ao') ?>"><?= $rao['ktoblmba']; ?></a></td>
								...
								<tr>
									<td><b>MSO</b></td>
									<td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/viewnok?datel=MSO&order=ao') ?>"><?= $rao['msoblmba']; ?></a></td>
								...
								<tr>
									<td><b>SLO</b></td>
									<td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/viewnok?datel=SLO&order=ao') ?>"><?= $rao['sloblmba']; ?></a></td>
								...
								<tr>
									<td><b>KAR</b></td>
									<td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/viewnok?datel=KAR&order=ao') ?>"><?= $rao['karblmba']; ?></a></td>
								...
								<tr>
									<td><b>SRG</b></td>
									<td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/viewnok?datel=SRG&order=ao') ?>"><?= $rao['srgblmba']; ?></a></td>
								...
								<tr>
									<td><b>SKH</b></td>
									<td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/viewnok?datel=SKH&order=ao') ?>"><?= $rao['skhblmba']; ?></a></td>
								...
								<tr>
									<td><b>WNG</b></td>
									<td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/viewnok?datel=WNG&order=ao') ?>"><?= $rao['wngblmba']; ?></a></td>
								...
								<tr>
									...
									<td style="background: #ff9999;"><a style="color: black;" href="<?= site_url('provisioning/ba_online/viewnok?datel=all&order=ao') ?>"><?= $rao['gtblmba']; ?></a></td>
