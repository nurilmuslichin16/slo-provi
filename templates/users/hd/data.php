<div class="col-xs-12 col-sm-12 widget-container-col" id="widget-container-col-1">
	...
	<div class="widget-box widget-color-dark" id="widget-box-1">
		<div class="widget-header">
			<h5 class="widget-title">Help Desk</h5>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('users/helpdesk/users_list')?>",
            "type": "POST"
        },
    ...
    $('#aktifkan').click(function(){
        ...
        if (appConfirm == true) {
            ...
            if(length > 0){
              ...
              $.ajax({
                url: "<?php echo site_url('users/helpdesk/approve_user')?>",
                type: 'post',
...
function edit_users(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('users/helpdesk/users_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
 
            $('[name="id"]').val(data.h_telegram_id);
            $('[name="nama_hd"]').val(data.nama_hd);
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('users/helpdesk/users_add')?>";
    } else {
        url = "<?php echo site_url('users/helpdesk/users_update')?>";
    }
...
function delete_users(id)
{
    ...
    {
        $.ajax({
            url : "<?php echo site_url('users/helpdesk/users_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-label col-md-3">Nama HD</label>
                            <div class="col-md-9">
                                <input name="nama_hd" placeholder="Nama Help Desk" class="form-control" type="text">
