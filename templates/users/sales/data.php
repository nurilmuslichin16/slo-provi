...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#table').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('users/salesman/users_list') ?>",
                "type": "POST"
            },
        ...
        $('#aktifkan').click(function() {
            ...
            if (appConfirm == true) {
                ...
                if (length > 0) {
                    ...
                    $.ajax({
                        url: "<?php echo site_url('users/salesman/approve_user') ?>",
                        type: 'post',
                        data: {
                            user_ids: users_arr
                        },
    ...
    function edit_users(id) {
        ...
        $.ajax({
            url: "<?php echo site_url('users/salesman/users_edit') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data) {

                $('[name="id"]').val(data.s_telegram_id);
    ...
    function save() {
        ...
        if (save_method == 'add') {
            url = "<?php echo site_url('users/salesman/users_add') ?>";
        } else {
            url = "<?php echo site_url('users/salesman/users_update') ?>";
        }
    ...
    function delete_users(id) {
        if (confirm('Are you sure delete this data?')) {
            $.ajax({
                url: "<?php echo site_url('users/salesman/users_delete') ?>/" + id,
                type: "POST",
                dataType: "JSON",
                success: function(data) {
                    $('#modal_form').modal('hide');
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="fullname" placeholder="Nama Help Desk" class="form-control" type="text">
